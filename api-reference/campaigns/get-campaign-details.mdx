...
api: "GET /api/v1/campaigns/{campaign_id}/details"
...
- **Formats de questions** : L'endpoint gère automatiquement plusieurs formats de stockage (JSON moderne avec poids, format legacy, texte simple)
- **Poids par défaut** : Si aucun poids n'est spécifié, la valeur par défaut est `1.0`
- **Permissions** : Seules les campagnes appartenant à votre agence sont accessibles
