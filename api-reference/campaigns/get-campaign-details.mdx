...
<CodeGroup>
```bash cURL
curl -X GET https://staging.app.voicehire.io/api/v1/campaigns/abc123def456/details \
...
response = requests.get(
    "https://staging.app.voicehire.io/api/v1/campaigns/abc123def456/details",
    headers={
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://staging.app.voicehire.io/api/v1/campaigns/abc123def456/details');
