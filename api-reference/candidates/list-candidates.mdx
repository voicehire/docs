...
<CodeGroup>
```bash cURL
curl -X GET "https://staging.app.voicehire.io/api/v1/campaigns/abc123def456/candidates?sort=score_desc" \
...
response = requests.get(
    "https://staging.app.voicehire.io/api/v1/campaigns/abc123def456/candidates",
    headers={
