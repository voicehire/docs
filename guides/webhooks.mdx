...
Connectez-vous à votre [tableau de bord VoiceHire](https://staging.app.voicehire.io) et accédez à la section API, puis à l'onglet Webhooks.
...
```json
{
  ...
  "data": {
    ...
    "contract_type": "CDI",
    "candidate_link": "https://staging.app.voicehire.io/candidate/abc123def456",
    "questions_count": 6,
    "status": "active"
  }
}
